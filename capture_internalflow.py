...
#http://huiyan.baidu.com/migration/internalflowhistory.jsonp?dt=city&id=420100&date=20200213&callback=jsonp_1581579398387_5437718
...
if __name__ == '__main__':
	if len(sys.argv) != 3:
		print(f"usage: {sys.argv[0]} date directory")
	else:
		date = sys.argv[1]
		...
		partone = "http://huiyan.baidu.com/migration/internalflowhistory.jsonp?dt=city&id="
		parttwo = "&date="
		...
		for id, name in cdic.items():
			request_url = partone + id + parttwo + date
			print('request_url is: ' + request_url)
			filename = "城内出行强度." + name + '.' + date + '.html'
