...
# http://huiyan.baidu.com/migration/historycurve.jsonp?dt=city&id=350100&type=move_in&startDate=20200101&endDate=20200128
...
if __name__ == '__main__':
	if len(sys.argv) != 5:
		print('usage: ' + sys.argv[0] + ' type (move_in or move_out) startdate enddate directory')
	else:
		...
		for id, name in cdic.items():
			request_url = partone + id + parttwo + type + partthree + startdate + partfour + enddate
			print('request_url is: ' + request_url)
			tmp = "人口迁入指数 " if type == 'move_in' else "人口迁出指数 "
			filename = tmp + name + '.' + startdate + '.' + enddate + '.html'
