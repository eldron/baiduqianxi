...
print(f'there are {len(citynames)} city names')
print(f'there are {len(cityids)} city ids')
print('the number of cities is ' + str(len(cdic)))

# max = 0
# dir = 'moveout_details2.3/'
# r = os.listdir(dir)
# for item in r:
# 	filename = dir + item
# 	f = open(filename, 'r')
...
# 	f.close()
# 	j = json.loads(s[3:-1])
# 	if len(j['data']['list']) > max:
# 		max = len(j['data']['list'])

# print(f'{max} cities for each city')