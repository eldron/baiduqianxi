...
print 'the number of cities is ' + str(len(cities))
print 'length of cdic is ' + str(len(cdic))
#print 'length of ids is ' + str(len(ids))
# for id, name in cdic.iteritems():
# 	print id + ' ' + name

date_range = range(20200101, 20200129)
partone = "http://huiyan.baidu.com/migration/cityrank.jsonp?dt=city&id="
parttwo = "&type=move_out&date="
for id, name in cdic.iteritems():
	for date in date_range:
		request_url = partone + id + parttwo + str(date)
		print 'request_url is: ' + request_url
		request_page = urllib2.urlopen(request_url)
		soup = BeautifulSoup(request_page, 'html.parser')
		filename = u"人口迁出详情 " + name + '.' + str(date) + '.html'
		print 'filename is: ' + filename
		f = open(filename, "w")
		f.write(soup.prettify())
		f.close()

# base_url = "http://huiyan.baidu.com/migration/cityrank.jsonp?dt=city&id=350300&type=move_out&date="
# start = 20200120
# for i in range(10):
# 	request_url = base_url + str(start + i)
# 	request_page = urllib2.urlopen(request_url)
# 	soup = BeautifulSoup(request_page, 'html.parser')
# 	print 'data for ' + str(start + i) + 'is'
# 	print soup.prettify()

# request_url = "http://huiyan.baidu.com/migration/cityrank.jsonp?dt=city&id=350300&type=move_out&date=20200128"
# request_page = urllib2.urlopen(request_url)
# soup = BeautifulSoup(request_page, 'html.parser')
# print soup.prettify()
# f = open('350300.20200128.html', "w+")
# f.write(soup.prettify())
# f.close()