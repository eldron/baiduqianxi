...
r = os.listdir("movein_index20192020")
print(len(r))
files = []
for item in r:
	if os.path.isfile("movein_index20192020/" + item):
		files.append(item)
print('number of files = ' + str(len(files)))

workbook = xlsxwriter.Workbook(u"人口迁入指数(2.1).xlsx")
...
for filename in files:
	...
	f = open("movein_index20192020/" + filename, "r")
	s = f.read()
	f.close()
